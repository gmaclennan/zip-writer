...
| --------------------------- | ------- | -------------- |
| zip-writer (@node-rs/crc32) | 721.94  | **fastest**    |
| zip-writer                  | 674.57  | 1.07x slower   |
| zip-writer (js crc32)       | 659.90  | 1.09x slower   |
...
| Library                     | ops/sec | Relative Speed |
| --------------------------- | ------- | -------------- |
| zip-writer                  | 23.91   | **fastest**    |
| zip-writer (@node-rs/crc32) | 22.91   | 1.04x slower   |
| zip-writer (js crc32)       | 18.93   | 1.26x slower   |
...
| Library                     | ops/sec | Relative Speed |
| --------------------------- | ------- | -------------- |
| zip-writer                  | 7.22    | **fastest**    |
| zip-writer (@node-rs/crc32) | 6.78    | 1.06x slower   |
| archiver                    | 5.65    | 1.28x slower   |
| zip-writer (js crc32)       | 4.82    | 1.50x slower   |
...
| zip-writer                  | 6.89    | 1.46x slower   |
| zip-writer (@node-rs/crc32) | 5.94    | 1.70x slower   |
| zip-writer (js crc32)       | 5.63    | 1.79x slower   |
